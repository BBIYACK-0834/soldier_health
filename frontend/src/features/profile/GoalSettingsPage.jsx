...
export default function GoalSettingsPage() {
  const [goalType, setGoalType] = useState(mockUser.goalType);
  return (
    <AppLayout title="목표 설정" showBottomNav={false}>
      <Card>
        <div className={styles.form}>
          <label>목표 체중<input className={screen.input} type="number" defaultValue={mockUser.targetWeight} /></label>
          <label>목표 기간<input className={screen.input} type="date" defaultValue={mockUser.targetDate} /></label>
